...
% \addbibresource{literature.bib} % Note this is different from \bibliography
\usepackage{natbib} % Using natbib for bibliography management
...
% Instead of \printbibliography, you use the natbib-compatible bibliography commands.

\bibliographystyle{ACM-Reference-Format}
\bibliography{literature.bib} % Your bibliography file name here.
